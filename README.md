...
- **Tools** (24): Rectangle/Ellipse/Lasso Select, Magic Wand, Move Selected Pixels, Move Selection, Zoom, Pan, Paintbrush, Pencil, Eraser, Paint Bucket, Gradient (linear/radial), Color Picker, Clone Stamp, Recolor, **Color Remover**, Text, Line, Curve, Rectangle, Rounded Rectangle, Ellipse, Freeform Shape. The floating palette uses original colored vectors with Paint.NET-familiar silhouettes and ordering.
