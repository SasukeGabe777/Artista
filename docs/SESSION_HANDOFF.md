...
(82 unit tests + 113 UI self-test checks pass; see README). This file tracks the
...
- UI self-test: 113 passed, 0 failed; screenshot QA includes dark/light floating Tools artwork, the main workspace, floating History panel, transform handles, docking targets, oversized-paste dialog, and drag/drop dialog.
